...
export const scores: ScoreRow[] = [
  { company: "Schneider Electric", year: 2020, provider: "MSCI", raw_score: "AAA", normalized_score: 95, environment_score: 94, social_score: 88, governance_score: 92, confidence: 80, methodology_gap: "Controversy and industry risk lens can lift or cap the rating differently than disclosure-led frameworks", data_gap: "Public disclosures were strong but some supply-chain and product-impact indicators were estimated", weighting_difference: "Climate strategy and governance receive heavier materiality weight than questionnaire completeness" },
  { company: "Schneider Electric", year: 2020, provider: "Sustainalytics", raw_score: "Not disclosed (~14 est.)", normalized_score: 82, environment_score: 85, social_score: 76, governance_score: 81, confidence: 60, methodology_gap: "Lower raw ESG risk maps inversely to normalized performance and can penalize unmanaged exposure", data_gap: "Pre-2022 exact score not publicly disclosed; estimated from 'strong management' public commentary", weighting_difference: "Material financial risk and management gap are weighted above broad disclosure volume" },
  { company: "Schneider Electric", year: 2020, provider: "CDP", raw_score: "A", normalized_score: 95, environment_score: 98, social_score: 78, governance_score: 80, confidence: 86, methodology_gap: "Climate questionnaire depth is rewarded more directly than cross-ESG governance coverage", data_gap: "Scope 3 and supplier data quality can create uncertainty across categories", weighting_difference: "Environmental disclosure and climate targets dominate the score" },
  { company: "Schneider Electric", year: 2020, provider: "S&P CSA", raw_score: "Not disclosed", normalized_score: 80, environment_score: 82, social_score: 76, governance_score: 80, confidence: 55, methodology_gap: "CSA rewards detailed questionnaire evidence and industry-specific practices", data_gap: "2020 CSA score not publicly disclosed; DJSI World inclusion confirmed", weighting_difference: "Industry materiality weights may emphasize operational eco-efficiency and labor practices" },
  { company: "Schneider Electric", year: 2021, provider: "MSCI", raw_score: "AAA", normalized_score: 95, environment_score: 94, social_score: 89, governance_score: 92, confidence: 82, methodology_gap: "MSCI-style industry risk controls may reward resilience in electrical equipment exposure", data_gap: "Some controversy and supply-chain inputs are inferred from public or third-party data", weighting_difference: "Governance and risk-management controls carry more weight than standalone disclosure" },
  { company: "Schneider Electric", year: 2021, provider: "Sustainalytics", raw_score: "Not disclosed (~13 est.)", normalized_score: 84, environment_score: 87, social_score: 78, governance_score: 82, confidence: 62, methodology_gap: "Risk score improves when unmanaged risk narrows even if absolute disclosures change modestly", data_gap: "Pre-2022 exact score behind paywall; estimated from public commentary", weighting_difference: "Unmanaged risk reduction is weighted above breadth of reporting" },
  { company: "Schneider Electric", year: 2021, provider: "CDP", raw_score: "A", normalized_score: 95, environment_score: 98, social_score: 78, governance_score: 80, confidence: 87, methodology_gap: "CDP climate leadership can exceed broader ESG provider scores", data_gap: "Environmental data is robust while social and governance depth is outside the core climate grade", weighting_difference: "Climate disclosure and emissions-management weight is dominant" },
  { company: "Schneider Electric", year: 2021, provider: "S&P CSA", raw_score: "~83 (est.)", normalized_score: 83, environment_score: 85, social_score: 79, governance_score: 83, confidence: 65, methodology_gap: "CSA questionnaire evidence can produce a smoother year-over-year path", data_gap: "2021 exact CSA score estimated; #1 in industry confirmed via DJSI inclusion", weighting_difference: "Environmental and social practices are balanced through sector-specific weights" },
  { company: "Schneider Electric", year: 2022, provider: "MSCI", raw_score: "AAA", normalized_score: 95, environment_score: 95, social_score: 89, governance_score: 93, confidence: 84, methodology_gap: "Top-tier rating can reflect relative peer strength as well as absolute controls", data_gap: "Third-party controversy screening can lag company reporting changes", weighting_difference: "Industry-adjusted risk management receives high weight" },
  { company: "Schneider Electric", year: 2022, provider: "Sustainalytics", raw_score: "Low–Negligible (~12)", normalized_score: 86, environment_score: 89, social_score: 79, governance_score: 84, confidence: 72, methodology_gap: "Low-risk category may still trail disclosure-led scores because residual exposure remains", data_gap: "Estimated exposure to product and supply-chain risks can create a ceiling", weighting_difference: "Financial materiality and unmanaged-risk weighting dampens climate leadership upside" },
  { company: "Schneider Electric", year: 2022, provider: "CDP", raw_score: "A", normalized_score: 95, environment_score: 99, social_score: 79, governance_score: 81, confidence: 88, methodology_gap: "Climate disclosure and target credibility remain primary drivers", data_gap: "Scope 3 boundary assumptions can affect confidence", weighting_difference: "Climate weighting is intentionally much higher than governance breadth" },
  { company: "Schneider Electric", year: 2022, provider: "S&P CSA", raw_score: "90", normalized_score: 90, environment_score: 92, social_score: 86, governance_score: 89, confidence: 86, methodology_gap: "Questionnaire-led CSA score may rise with evidence quality and detailed policy proof", data_gap: "Survey non-response or limited fields can hold down subtopic scores", weighting_difference: "Industry materiality distributes weight across environmental innovation and workforce topics" },
  { company: "Schneider Electric", year: 2023, provider: "MSCI", raw_score: "AAA", normalized_score: 95, environment_score: 95, social_score: 90, governance_score: 93, confidence: 85, methodology_gap: "Relative peer methodology can sustain high rating even when other frameworks identify gaps", data_gap: "Public and estimated data are mixed for some value-chain indicators", weighting_difference: "Governance controls and industry materiality carry strong influence" },
  { company: "Schneider Electric", year: 2023, provider: "Sustainalytics", raw_score: "Negligible (~10)", normalized_score: 90, environment_score: 92, social_score: 84, governance_score: 88, confidence: 80, methodology_gap: "Residual unmanaged risk can keep the normalized score below disclosure-heavy ratings", data_gap: "Event monitoring and exposure models can shift independently of company submissions", weighting_difference: "Unmanaged risk and exposure are more important than total disclosure volume" },
