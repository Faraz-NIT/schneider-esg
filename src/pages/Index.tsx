          ...
          <div className="mb-6 flex items-end justify-between">
            <div>
              ...
              <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">
                Built by a cross-functional cohort
              </h2>
              <p className="mt-1 text-sm text-muted-foreground">
                Finance, Strategy &amp; Consulting, and Data Science &amp; AI — joining forces on Schneider's ESG signal.
              </p>
            </div>
          </div>
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              <Card
                key={group.cohort}
                className={`overflow-hidden border-border/60 bg-gradient-to-br ${group.accent}`}
              >
                <div className="p-5">
                  ...
                  <ul className="space-y-2">
                    {group.members.map((name) => {
                      ...
                      return (
                        <li
                          key={name}
                          className="flex items-center gap-3 rounded-md bg-background/60 px-3 py-2 backdrop-blur-sm"
                        >
